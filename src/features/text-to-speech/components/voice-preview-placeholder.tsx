            ...
            <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-lg font-semibold tracking-tight text-foreground">
                    ...
                    <p className="max-w-64 text-center text-sm text-muted-foreground">
                        Once you generate speech, your audio will appear here. Sit back and relax while you listen to your text come to life.
                    </p>
            </div>
            <Button variant="outline" size="sm" asChild>
                <Link href="https://github.com/shubhamraj82/resonance.git">
                <BookOpen/>
                Don&apos;t know how ?
                </Link>
            </Button>
