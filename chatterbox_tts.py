"""Chatterbox TTS API - Text-to-speech with voice cloning and multi-speaker support."""
...
R2_ACCOUNT_ID="54dcd46e5e2d5dc1de951c2b5ecdb90a"
R2_MOUNT_PATH="/r2"
    ...
    def serve(self):
        ...
        def generate_speech(request:TTSRequest):
            ...
            if not voice_path.exists():
                raise HTTPException(status_code=400, detail=f"Voice not found '{request.voice_key}'",)
